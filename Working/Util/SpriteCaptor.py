...
class SpriteCaptor:
    ...
    def scale_rect2(self, scale, image_pos):
        ...
        w = self.rect.width = self.rect.width * scale
        h = self.rect.height = self.rect.height * scale
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(surface, "Black", [0, 465, 250, 35])
        pygame.draw.rect(surface, "White", [0, 465, 250, 35], width=2)
        surface.blit(self.rect_info, (5, 465))
